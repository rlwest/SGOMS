...
class MyAgent(ACTR):
    ...
    def run_situated(
            b_context='finshed:XY status:unoccupied'):  # status:unoccupied triggers the selection of a planning unit
        b_plan_unit.set(
    ...
    ## body of the unit task
    def y_cut_the_blue_wire(b_unit_task='unit_task:Y state:running type:?type',
                          b_focus='start'):
        b_focus.set('part_2')
        print 'pretending to do unit task Y, part 1'
